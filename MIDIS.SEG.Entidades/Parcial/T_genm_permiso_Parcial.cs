...
{
    public partial class T_genm_permiso 
    {
        #region generales

        public T_genm_permiso() { }

        public T_genm_permiso(IDataReader vReader)
        {
            
			this.Idpermiso = Convert.ToDecimal(vReader["Idpermiso"]);  
			this.Nombre_permiso = Convert.ToString(vReader["Nombre_permiso"]);  
