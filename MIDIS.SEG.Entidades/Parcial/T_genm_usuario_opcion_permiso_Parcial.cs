...
{
    public partial class T_genm_usuario_opcion_permiso 
    {
        #region generales

        public T_genm_usuario_opcion_permiso() { }

        public T_genm_usuario_opcion_permiso(IDataReader vReader)
        {
            
			this.Id_usuario_opcion_permiso = Convert.ToDecimal(vReader["Id_usuario_opcion_permiso"]);  
			this.Id_usuario_opcion = Convert.ToDecimal(vReader["Id_usuario_opcion"]);  
        ...
        [DataMember]
        public Decimal IdUsuarioOpcionPermiso { get; set; }

        [DataMember]
        public Decimal IdUsuarioOpcion { get; set; }  
