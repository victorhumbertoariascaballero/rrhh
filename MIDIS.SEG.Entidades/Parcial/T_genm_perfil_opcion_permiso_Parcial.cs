...
{
    public partial class T_genm_perfil_opcion_permiso 
    {
        #region generales

        public T_genm_perfil_opcion_permiso() { }

        public T_genm_perfil_opcion_permiso(IDataReader vReader)
        {
            
			this.Id_perfil_opcion_permiso = Convert.ToDecimal(vReader["Id_perfil_opcion_permiso"]);  
