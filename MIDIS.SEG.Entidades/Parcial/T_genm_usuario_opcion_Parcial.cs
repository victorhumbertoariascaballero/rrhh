...
{
    public partial class T_genm_usuario_opcion 
    {
        #region generales

        public T_genm_usuario_opcion() { }

        public T_genm_usuario_opcion(IDataReader vReader)
        {
        ...
        [DataMember]
        public List<T_genm_usuario_opcion_permiso> ListaUsuarioOpcionPermiso { get; set; }
