...
{
    public partial class T_genm_accion
    {
        #region generales

        public T_genm_accion() { }

        public T_genm_accion(IDataReader vReader)
        {

            this.Id_accion = Convert.ToDecimal(vReader["Id_accion"]);
            this.Nombre_accion = Convert.ToString(vReader["Nombre_accion"]);
