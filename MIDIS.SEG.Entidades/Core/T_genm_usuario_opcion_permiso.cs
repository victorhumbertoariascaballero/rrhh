...
{
    [DataContract]
    public partial class T_genm_usuario_opcion_permiso : BEPaginacion
    {
        #region Propiedades
        [DataMember]  
		public decimal Id_usuario_opcion_permiso { get; set; }  
		[DataMember]  
		public decimal Id_usuario_opcion { get; set; }  
		[DataMember]  
