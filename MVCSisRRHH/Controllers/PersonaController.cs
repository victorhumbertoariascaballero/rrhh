...
namespace MVCSisRRHH.Controllers
{
    ...
    public class PersonaController : Controller
    {
        ...
        public JsonResult Validar(Persona_Registro registro)
        {
            ...
            registro.RegistroUsuarioCreacion = (int)VariablesWeb.ConsultaInformacion.iCodUsuario; ;
        ...
        {
            //JObject autenticadoDeCookie = JObject.Parse(CookieSeguridadHelper.ObtenerAutenticado().ToString());
            registro.RegistroUsuarioModificacion = (int)VariablesWeb.ConsultaInformacion.iCodUsuario; ;
        ...
        public async Task<JsonResult> Buscar()
        {
            ...
            try
            {
                //maePersona = obtenerDesdeWS_PIDE(vNumDocum);
                //maePersona = obtenerDesdeWS_RENIEC(vNumDocum);

                //if (maePersona.Nombres != null) //Si es diferente a null
                //{
                //    //if (maePersona.Sexo == "M") //nIdeTipoGenero
                //    //    ViewBag.genero = "Masculino";
                //    //else
                //    //    ViewBag.genero = "Femenino";

                //    // INSERTAMOS LA PERSONA EN NUESTRA TABLA MAESTRA 
                //    maePersona.TipoDeDocumento = tipoDoc;
                //    maePersona.NumeroDeDocumento = vNumDocum;
                //    maePersona.DniValidoEnReniec = true;
                //    maePersona.TieneDocumento = true;
                //    maePersona.DomicilioEstaConfirmado = true;
                //    //maePersona.IdUbigeoDomicilio = maePersona.Ubigeo.IdUbigeo;
                //    maePersona.RegistroUsuarioCreacion = 1; // (int)VariablesWeb.ConsultaInformacion.iCodUsuario; ;
                //    maePersona.RegistroFechaCreacion = DateTime.Now;
                //    maePersona.RegistroIpCreacion = Request.UserHostAddress;

                //    // POR AHORA NO LO INSERTAMOS EN LA MAE_MAESTRA
                //    //object respuesta = _persona_Servicio.Insertar(maePersona);
                //}
                //else {
                //    maePersona = obtenerDesdeWS_PIDE(vNumDocum);
                //    if (maePersona.Nombres != null) //Si es diferente a null
                ...
                //        maePersona.DomicilioEstaConfirmado = true;
                //        //maePersona.IdUbigeoDomicilio = maePersona.Ubigeo.IdUbigeo;
                //        maePersona.RegistroUsuarioCreacion = (int)VariablesWeb.ConsultaInformacion.iCodUsuario; ;
                //        maePersona.RegistroFechaCreacion = DateTime.Now;
                //        maePersona.RegistroIpCreacion = Request.UserHostAddress;
                //    }
                //}
