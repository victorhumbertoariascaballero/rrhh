        ...
        this.$grid = $("#divGridSisper").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (item) {
                        var controles = "";
                        controles += '<a href="' + controladorApp.obtenerRutaBase() + 'Boletas/DescargarBoleta?anio=' + item.Anio + '&mes=' + item.Mes + '&trabajador=' + item.Trabajador + '&planilla=' + item.IdPlanilla + '&tipoplanilla=' + item.TipoPlanilla + '" class="btn btn-info btn-xs descarga"><span class="glyphicon glyphicon-file"></span></a>';
