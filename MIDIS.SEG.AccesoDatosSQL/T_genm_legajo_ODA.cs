...
{
    public partial class T_genm_legajo_ODA
    {
        ...
        public IEnumerable<Legajo_Registro> Listar(Postulante_Request peticion)
        {
            List<Legajo_Registro> lista = new List<Legajo_Registro>();
            Legajo_Registro item = null;

            using (SqlCommand cmd = _iBasesSqlAdoUnitOfWork.ObtenerComandoDeConexion())
            {
                if (cmd.Connection.State != ConnectionState.Open) cmd.Connection.Open();
                cmd.CommandText = "[dbo].[usp_Legajo_listar]";
                cmd.CommandType = CommandType.StoredProcedure;
                //cmd.CommandTimeout = cmd.CommandTimeout;

                cmd.Parameters.Add(new SqlParameter("@ID_LEGAJO", peticion.IdLegajo));
                cmd.Parameters.Add(new SqlParameter("@ID_TIPODOCUMENTO", peticion.IdTipoDocumento));
                ...
                using (SqlDataReader dr = cmd.ExecuteReader())
                {
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            item = new Legajo_Registro();

                            item.Grilla = new Grilla_Response();
                            item.IdPostulante = dr.GetInt32(dr.GetOrdinal("iCodLegajo"));
                            item.TipoDocumento = dr.GetInt32(dr.GetOrdinal("iCodTipoDocumento"));
                            ...
                            item.IdDrive = dr.GetString(dr.GetOrdinal("vIdDriveRaiz"));
                            item.IdDrive1 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion1"));
                            item.IdDrive2 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion2"));
                            item.IdDrive3 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion3"));
                            item.IdDrive4 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion4"));
                            item.IdDrive5 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion5"));
                            item.IdDrive6 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion6"));
                            item.IdDrive7 = dr.GetString(dr.GetOrdinal("vIdDriveSeccion7"));
        ...
        public Int32 InsertarLegajo(Legajo_Registro registro)
        {
            ...
            {
                if (cmd.Connection.State != ConnectionState.Open) cmd.Connection.Open();
                cmd.CommandText = "[dbo].[Usp_Legajo_ins]";
                cmd.CommandType = CommandType.StoredProcedure;
                //cmd.CommandTimeout = cmd.CommandTimeout;

                cmd.Parameters.Add(new SqlParameter("@iCodLegajo", registro.IdPostulante));
                cmd.Parameters.Add(new SqlParameter("@iCodigoTipoDocumento", registro.TipoDocumento));
                cmd.Parameters.Add(new SqlParameter("@vNumeroDocumento", registro.NroDocumento));
                cmd.Parameters.Add(new SqlParameter("@vNombres", registro.Nombre.ToUpper()));
                cmd.Parameters.Add(new SqlParameter("@vApellidoPaterno", registro.Paterno.ToUpper()));
                ...
                cmd.Parameters.Add(new SqlParameter("@bEstado", 1));
                cmd.Parameters.Add(new SqlParameter("@vUbigeo", registro.DescripcionUbigeo));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveRaiz", registro.IdDrive));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion1", registro.IdDrive1));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion2", registro.IdDrive2));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion3", registro.IdDrive3));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion4", registro.IdDrive4));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion5", registro.IdDrive5));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion6", registro.IdDrive6));
                cmd.Parameters.Add(new SqlParameter("@vIdDriveSeccion7", registro.IdDrive7));
                cmd.Parameters.Add(new SqlParameter("@dtAuditCreacion", registro.FechaRegistro));
                cmd.Parameters.Add(new SqlParameter("@vAuditCreacion", registro.IdUsuarioRegistro));
        ...
        public Int32 InsertarLegajoDocumento(Legajo_Registro registro)
        {
            ...
            {
                if (cmd.Connection.State != ConnectionState.Open) cmd.Connection.Open();
                cmd.CommandText = "[dbo].[Usp_LegajoDocumento_ins]";
                cmd.CommandType = CommandType.StoredProcedure;
                //cmd.CommandTimeout = cmd.CommandTimeout;
