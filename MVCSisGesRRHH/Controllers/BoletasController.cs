    ...
    public class BoletasController: Controller
	{
        ...
        public JsonResult RegistrarSolicitudDescargaBoleta(String dni)
        {
            try
            {
                ...
                if (lista == null)
                {
                    return Json(new { success = "False", responseText = "El número de documento ingresado no existe en la nómina de trabajadores" });
                }
                else {
                    if (lista.Count > 0)
                    {
                        if (String.IsNullOrEmpty(lista[0].CorreoElectronicoLaboral))
                            return Json(new { success = "False", responseText = "El número de documento ingresado corresponde a un trabajador que no tiene un correo electrónico ingresado. Comuníquese con la Oficina General de Recursos Humanos" });
                        else {
...
"</div>";
        ...
        //                msg.From = new MailAddress(ConfigurationManager.AppSettings["correo"].ToString());
        //                msg.Subject = "Infórmate sobre el nuevo Reglamento Interno de los/las Servidores/as Civiles del MIDIS";
        ...
        ////"<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:justify;line-height:normal'><span lang=ES style='font-family:'Arial Black,sans-serif'>Mediante el presente ponemos a tu disposición el nuevo Reglamento Interno de los/las Servidores/as Civiles del Ministerio de Desarrollo e Inclusión Social.<br> "  + 
        //"<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:justify;line-height:normal'><span lang=ES style='font-family:'Arial Black,sans-serif'>¿Sabias que?<br>El RIS tiene por objeto normar las relaciones laborales y condiciones a las que se someten cada una de las partes  de la relación laboral que se tiene con el MIDIS, propiciando, fomentando y manteniendo la armonía en las relaciones laborales, orientada al logro de los objetivos institucionales y la mejora de los servicios brindados a la ciudadanía.<br><br>" + 
        ...
        //"Ponemos a tu disposición el Nuevo Reglamento Interno de los/las Servidores/as Civiles del MIDIS <u><span" +
        //"style='color:red'>" + "<a style='color:red' href='" + ConfigurationManager.AppSettings["URL_MAIL"].ToString() + "DescargarNotificacion/?id=" + urlCrypto + "' target='_blank'> Descárgalo aqui</a>" + "</span></u>.<o:p></o:p></span></p>" +
        ...
        //                msg.From = new MailAddress(ConfigurationManager.AppSettings["correo"].ToString());
        //                msg.Subject = "Infórmate sobre Plan para Vigilancia, prevención y control de Covid-19 en el trabajo del MIDIS";
        ...
        ////"<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:justify;line-height:normal'><span lang=ES style='font-family:'Arial Black,sans-serif'>Mediante el presente ponemos a tu disposición el nuevo Reglamento Interno de los/las Servidores/as Civiles del Ministerio de Desarrollo e Inclusión Social.<br> "  + 
        //"<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:justify;line-height:normal'><span lang=ES style='font-family:'Arial Black,sans-serif'>¿Sabes cuáles son las actividades, acciones e intervenciones que aseguren la vigilancia, prevención y control de COVID-19 en el MIDIS?<br><br>Conoce más sobre nuestro Plan para la Vigilancia, prevención y control de COVID-19 en el trabajo del Ministerio de Desarrollo e Inclusión Social MIDIS.<br><br>" +
        //                    //"Para visualizarla e imprimirla <u><span" +
        //                    //"style='color:red'>" + "<a style='color:red' href='" + ConfigurationManager.AppSettings["URL_MAIL"].ToString() + "DescargarNotificacion/?id=" + urlCrypto + "' target='_blank'> Haz click aqui</a>" + "</span></u>.<o:p></o:p></span></p>" +
        ////"<u><span style='color:red'>" + "<a style='color:red' href='" + ConfigurationManager.AppSettings["URL_MAIL"].ToString() + "DescargarNotificacion/?id=" + urlCrypto + "' target='_blank'> Descárgalo aqui</a>" + "</span></u>.<o:p></o:p></span></p>" +
        //"<u><span style='color:red'>" + "<a style='color:red' href='https://cdn.www.gob.pe/uploads/document/file/733522/RJ_010_2020_MIDIS_SG_OGRH.pdf' target='_blank'> Descárgalo aqui</a>" + "</span></u>.<o:p></o:p></span></p>" +
        ...
        private Boolean SendEmailNotificacion(Empleado_Registro empleado)
        {
            ...
            if (!String.IsNullOrEmpty(empleado.CorreoElectronicoLaboral))
            {
                ...
                msg.From = new MailAddress(ConfigurationManager.AppSettings["correo"].ToString());
                msg.Subject = "Certificación del curso virtual: 'La alimentación escolar como estrategia educativa para una vida saludable'";
...
"<p class=MsoNormal style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;" +
"margin-left:141.6pt;margin-bottom:.0001pt;text-align:justify;text-indent:35.4pt;" +
"line-height:normal'><span lang=ES style='font-family:'Arial Black,sans-serif'>Ministerio de Desarrollo e Inclusión Social<o:p></o:p></span></p>" +
        ...
        public void upload()
        {
            ...
            try
            {
                ...
                if (!System.IO.File.Exists(Path.Combine(filePathExtractor + "\\log.txt"))) {
                    ...
                    {
                        byte[] info = new UTF8Encoding(true).GetBytes(String.Format("{0}-{1}", DateTime.Now.ToString(), "Inicio de descompresión del archivo 7z"));
                ...
                using (StreamWriter sw = System.IO.File.AppendText(Path.Combine(filePathExtractor + "\\log.txt")))
                {
                    sw.WriteLine(String.Format("{0}-{1}", DateTime.Now.ToString(), "Archivos extraidos con éxito"));
                }
