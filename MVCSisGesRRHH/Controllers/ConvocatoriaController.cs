...
namespace MVCSisGesRRHH.Controllers
{
    public class ConvocatoriaController: Controller
	{
        ...
        [HttpGet]
        public JsonResult ListarPostulantesServir(Convocatoria_Request peticion)
        {
            //peticion.Nombre = "%" + (String.IsNullOrEmpty(peticion.Nombre) ? "" : peticion.Nombre.ToUpper()) + "%";
            object respuesta = _convocatoria_Servicio.ListarPostulantesServir(peticion);
            return Json(respuesta, JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        ...
        [HttpGet]
        public JsonResult ListarPostulantesServirEvaluacionCurri(Convocatoria_Request peticion)
        {
            //peticion.Nombre = "%" + (String.IsNullOrEmpty(peticion.Nombre) ? "" : peticion.Nombre.ToUpper()) + "%";
            object respuesta = _convocatoria_Servicio.ListarPostulantesServirEvaluacionCurri(peticion);
            var jsonResult = Json(respuesta, JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = Int32.MaxValue;
        ...
        [HttpGet]
        public JsonResult ListarPostulantesServirEvaluacionConocimiento(Convocatoria_Request peticion)
        {
            //peticion.Nombre = "%" + (String.IsNullOrEmpty(peticion.Nombre) ? "" : peticion.Nombre.ToUpper()) + "%";
            object respuesta = _convocatoria_Servicio.ListarPostulantesServirEvaluacionConocimiento(peticion);
            return Json(respuesta, JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        ...
        [HttpPost]
        public JsonResult ActualizarServirEvaluacionCurri(PostulacionEvaluacionCurricular_Registro registro)
        {
            try
            {
                //registro.FechaModificacion = DateTime.Now;
                ...
                object respuesta = _convocatoria_Servicio.ActualizarServirEvaluacionCurri(registro);
        ...
        [HttpPost]
        public JsonResult ObtenerServirParaEditar(Convocatoria_Request peticion)
        {
            Convocatoria_Registro respuesta = _convocatoria_Servicio.ObtenerServirParaEditar(peticion);
            //respuesta.Contrasena = HttpUtility.UrlEncode(new Crypto().Encriptar(peticion.IdConvocatoria + "|" + VariablesWeb.ConsultaInformacion.iCodUsuario.ToString()));
        ...
        [HttpGet]
        public JsonResult ListarConvocatoriaServirComite(Convocatoria_Request peticion)
        {
            object respuesta = _convocatoria_Servicio.ListarConvocatoriaServirComite(peticion);
            return Json(respuesta, JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        ...
        [HttpPost]
        public JsonResult EliminarComunicadoServir(ConvocatoriaDocumento_Registro registro)
        {
            try
            {
                registro.FechaRegistro = DateTime.Now;
                ...
                object respuesta = _convocatoria_Servicio.EliminarComunicadoServir(registro);
        ...
        [HttpGet]
        public ActionResult DescargarArchivoServir(String idConvocatoria, String idTipo)
        {
            Convocatoria_Request peticion = new Convocatoria_Request();
            peticion.IdConvocatoria = Int32.Parse(idConvocatoria);

            Convocatoria_Registro item = _convocatoria_Servicio.ObtenerConvocatoriaServirDocumento(peticion);
        ...
        [HttpGet]
        public ActionResult DescargarArchivoServirPorId(String idConvocatoriaDoc)
        {
            Convocatoria_Request peticion = new Convocatoria_Request();
            peticion.IdConvocatoriaDocumento = Int32.Parse(idConvocatoriaDoc);
            //peticion.IdConvocatoria = Int32.Parse(idConvocatoria);

            Convocatoria_Registro item = _convocatoria_Servicio.ObtenerConvocatoriaServirDocumentoPorId(peticion);
