            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (item) {
                        ...
                        if (item.Estado == 1) {
                            controles += '<button type="button" class="btn btn-danger btn-xs" onclick="controlador.abrirModalCesePersona(\'' + item.IdEmpleado + '\',\'' + item.NroDocumento + '\')">';
                            controles += '<span class="glyphicon glyphicon-remove" aria-hidden="true" data-uib-tooltip="Eliminar" title="Dar de baja al trabajador"></span>';
                            controles += '</button>';
                        }
                        //if (item.Estado == 0) {
                        //    controles += '<button type="button" class="btn btn-info btn-xs" onclick="controlador.abrirModalRegistroPersona(\'' + item.IdEmpleado + '\',\'' + item.NroDocumento + '\')">';
