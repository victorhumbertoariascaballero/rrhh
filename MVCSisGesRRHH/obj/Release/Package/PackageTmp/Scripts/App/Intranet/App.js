(function ($) {
            ...
            .ajaxError(function (e, xhr, opts) {
                ...
                switch (xhr.status) {
                    case 0: //401
                        ...
                        setTimeout(function () { window.location = rutaBase + 'Account/'; }, 1000);
                        break;
                    //case 401: //401
                    //    controladorApp.notificarMensajeDeError("La sesión ha terminado");
    ...
    this.IntranetAppJS.prototype.abrirMensajeDeConfirmacion2 = function (mensaje, textoSi, textoNo, objFuncionOk, objFuncionCancel) {
        var divConfirm = document.createElement('div');
        divConfirm.id = 'divConfirm';
