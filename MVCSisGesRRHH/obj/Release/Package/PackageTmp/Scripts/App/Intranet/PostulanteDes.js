                ...
                },
                {
                    ...
                    template: function (item) {
                        ...
                        if (item.IdPostulacion == 0 && item.IdConvocatoria == 0) {
                            controles += '<button type="button" class="btn btn-info btn-xs" onclick="controlador.editarFormatoFicha(' + item.IdPostulante + ',' + item.IdPostulacion + ',' + item.IdConvocatoria + ')">';
                            controles += '<span class="glyphicon glyphicon-edit" aria-hidden="true" data-uib-tooltip="Editar" title="Actualizar ficha del postulante"></span>';
                            controles += '</button>';
                        }
