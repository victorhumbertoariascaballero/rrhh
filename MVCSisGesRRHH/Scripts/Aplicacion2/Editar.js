...
$(function () { 
    ...
    $("#btnGuardarAplicacion").click(function () {
        jqMensaje("Confirmar", "Está seguro de grabar los cambios de la aplicacion?",
        function (data) {
            if (data) {
                var app = {
                ...
                $.getJSON(globalRutaServidor + "Aplicacion2/GrabarAplicacion",
                    app,
                    function (data) {
                        if (!data.rpta) {
