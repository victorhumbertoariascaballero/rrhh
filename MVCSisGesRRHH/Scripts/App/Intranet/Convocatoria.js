(function ($) {
    ...
    this.ConvocatoriaJS.prototype.inicializarGrid = function () {
        ...
        this.$dataSource = new kendo.data.DataSource({
            ...
            group: [
                {   field: "Año", aggregate: "count", dir: "desc" },
            ],
            sort: 
                { field: "Año", dir: "desc" }
    ...
    function detailInit(e) {
        ...
        detailRow.find(".postulantes").kendoGrid({
            ...
            dataSource: {
                ...
                transport: {
                    read: {
                        url: controladorApp.obtenerRutaBase() + 'Convocatoria/ListarPostulantes',
                        type: 'GET',
                        dataType: 'json',
                        cache: false
                    },
    ...
    this.ConvocatoriaJS.prototype.abrirModalRegistroConvocatoria = function (id) {
        ...
        if (id == 0) {           
            ...
            modal.title("Ingresar Proceso de Convocatoria CAS");
            //modal.center();
            modal.open();
        }
        //else {
    ...
    this.ConvocatoriaJS.prototype.abrirModalEdicionConvocatoria = function (id) {
                    ...
                    $.ajax({
                        ...
                        success: function (resul) {
                            ...
                            if (res.IdTieneRequerimiento == 1) {
                                ...
                                $("#btnActualDocRequerimientoE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivo/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=1');
                            ...
                            if (res.IdTieneCertificacion == 1) {
                                ...
                                $("#btnActualDocCertificacionE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivo/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=2');
                            ...
                            if (res.IdTieneComite == 1) {
                                ...
                                $("#btnActualDocComiteE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivo/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=3');
        ...
        this.$dataSourceTotales = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: controladorApp.obtenerRutaBase() + 'Convocatoria/ListarPostulantesResultadosTotales',
                    type: 'GET',
                    dataType: 'json',
                    cache: false
                },
        ...
        this.$gridComunicacion = $("#divGridComunicacion").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (item) {
                        var controles = "";
                        controles += '<a href="' + controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPorId/?idConvocatoriaDoc=' + item.IdConvocatoriaDocumento + '" target="_blank" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-file" title="Descargar comunicado"></span></a>';
    ...
    this.ConvocatoriaJS.prototype.abrirModalFormato = function () {
    ...
    this.ConvocatoriaJS.prototype.abrirModalFormatoEnt = function (id, postulante, examen) {
    ...
    this.ConvocatoriaJS.prototype.cerrarModalEdicionConvocatoria = function () {
        var modal = $('#divModalEdicionConvocatoria').data('kendoWindow');
        modal.close();
    }
    this.ConvocatoriaJS.prototype.cerrarModalEvaluacionCurri = function () {
        var modal = $('#divModalEvaluacionCurri').data('kendoWindow');
        modal.close();
    }
    this.ConvocatoriaJS.prototype.cerrarModalAsignarEvaluacion = function () {
        var modal = $('#divModalAsignarEvaluacion').data('kendoWindow');
        modal.close();
    }

    this.ConvocatoriaJS.prototype.TipoDocumentoDropDownEditor = function (container, options) {
    ...
    this.ConvocatoriaJS.prototype.agregarConvocatoria = function (e) {
        ...
        if (frmRegistroConvocatoria.validate()) {
            ...
            controladorApp.abrirMensajeDeConfirmacion(
                '<span>¿Está seguro de ingresar la convocatoria CAS?.</span></br></br><div class="alert alert-warning" style="padding: 5px; border: 1px solid #f7cf0aa0;">Recuerde que al confirmar esta operación la convocatoria automaticamente será publicada</div>', 'SI', 'NO'
                , function (arg) {
                    $.ajax({
    ...
    this.ConvocatoriaJS.prototype.actualizarConvocatoria = function (e) {
        e.preventDefault();
    ...
    this.ConvocatoriaJS.prototype.agregarEvaluacionEntrevista = function (e) {
        e.preventDefault();
    ...
    this.ConvocatoriaJS.prototype.asignarEvaluacionCurricular = function (e) {
        e.preventDefault();
    ...
    this.ConvocatoriaJS.prototype.agregarResultadoFinalArchivo = function (e) {
        e.preventDefault();
    ...
    this.ConvocatoriaJS.prototype.limpiarEvaluacionEntrevista = function (IdEvaluacion) {
    ...
    this.ConvocatoriaJS.prototype.declararAccesitarioGanador = function (IdPostulacion, IdPostulante, IdConvocatoria) {
    ...
    this.ConvocatoriaJS.prototype.agregarConvocatoriaDocumento = function (e) {
        e.preventDefault();
    ...
    this.ConvocatoriaJS.prototype.cerrarModalFormatoEnt = function () {
        $('#divModalFormatoEnt').data('kendoWindow').close();
    }

    this.ConvocatoriaJS.prototype.inicializarGridConocimientos = function () {
        var data_param = new FormData();
        data_param.append('IdConvocatoria', $('#hdIdConvocatoria').val());
        //$.ajax({
        //    url: controladorApp.obtenerRutaBase() + 'Convocatoria/ObtenerParaEditar',
    ...
    this.ConvocatoriaJS.prototype.inicializarGridCurricular = function () {
        var data_param = new FormData();
        data_param.append('IdConvocatoria', $('#hdIdConvocatoria').val());
    ...
    this.ConvocatoriaJS.prototype.abrirModalEvaluacionCurri = function (IdConvocatoria) {
        //$("#fileFormato").data("kendoUpload").clearAllFiles();
    ...
    this.ConvocatoriaJS.prototype.abrirModalAsignarEvaluacion = function (IdConvocatoria, IdDependencia) {
        $('#hdIdConvocatoria').val(IdConvocatoria);
    ...
    this.ConvocatoriaJS.prototype.abrirModalEvaluacionConocimiento = function (IdConvocatoria) {
        window.open(controladorApp.obtenerRutaBase() + 'Convocatoria/EvaluacionConocimiento/?id=' + IdConvocatoria, '_blank');
    }
    this.ConvocatoriaJS.prototype.abrirModalEvaluacionEntrevista = function (IdConvocatoria) {
        //$("#fileFormato").data("kendoUpload").clearAllFiles();
        $('#hdIdConvocatoria').val(IdConvocatoria);
    ...
    this.ConvocatoriaJS.prototype.ObservacionEditor = function (container, options) {
        $('<textarea name="' + options.field + '" style="width: 98%;" />')
            .appendTo(container);
    };
    this.ConvocatoriaJS.prototype.FechaEntrevistaEditor = function (container, options) {
    ...
    this.ConvocatoriaJS.prototype.HoraEntrevistaEditor = function (container, options) {
    ...
    this.ConvocatoriaJS.prototype.GenerarFormatoComunicado = function () {
    ...
    this.ConvocatoriaJS.prototype.GenerarFormatoResultadoFinal = function () {
        var IdConvocatoria = $('#hdIdConvocatoria').val();
    ...
    this.ConvocatoriaJS.prototype.EliminarComunicado = function (IdComunicado) {
        var data_param = new FormData();
        ...
        controladorApp.abrirMensajeDeConfirmacion(
            ...
            , function (arg) {
                $.ajax({
                    url: controladorApp.obtenerRutaBase() + 'Convocatoria/EliminarComunicado',
                    type: 'POST',
                    dataType: 'json',
                    contentType: false,
                    processData: false,
