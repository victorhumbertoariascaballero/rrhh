(function ($) {
    ...
    this.PlanillaJS.prototype.inicializarMaestro = function () {
    ...
    this.PlanillaJS.prototype.inicializarGridMaestro = function () {
        var _this = this;
        this.$dataSource = [];
        this.$dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: controladorApp.obtenerRutaBase() + 'ReportesCA/GetPlanilla',
                    type: 'GET',
                    dataType: 'json',
                    cache: false
                },
        ...
        this.$grid = $("#divGrid").kendoGrid({
            ...
            excel: {
                fileName: "Reporte Planillas.xlsx",
                filterable: false
            },
    ...
    this.PlanillaJS.prototype.buscar = function (e) {
        e.preventDefault();
        ////debugger;
    ...
    this.PlanillaJS.prototype.generarColumnas = function () {
        var columnas = [
            {
            ...
            {
                field: "vMinTardanza",
                title: "TOTAL DE MINUTOS DE TARDANZA",
                filterable: { multi: true, search: true, ignoreCase: true }
            },
            {
                field: "vMinSalidaAntes",
                title: "TOTAL DE MINUTOS SALIDA ANTES DEL FIN DE LA JORNADA",
                filterable: { multi: true, search: true, ignoreCase: true }
            },
            {
                field: "vMinPermisoPer",
                title: "TOTAL DE MINUTOS DE PERMISO PERSONAL",
                filterable: { multi: true, search: true, ignoreCase: true }
            },
            {
                field: "vMinPeriodos",
                title: "TOTAL DE MINUTOS POR EL PERIODO",
                filterable: { multi: true, search: true, ignoreCase: true }
            },
            {
                field: "vNroFaltas",
            ...
            {
                field: "vLicSinGoce",
                title: "TOTAL DE LICENCIA SIN GOCE",
                filterable: { multi: true, search: true, ignoreCase: true }
            },
            {
                field: "vDiasPorPeriodo",
                title: "TOTAL DE DIAS POR EL PERIODO",
                filterable: { multi: true, search: true, ignoreCase: true }
            }
        ]
        return columnas;
