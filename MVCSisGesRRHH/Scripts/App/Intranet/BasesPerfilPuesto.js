(function ($) {
    ...
    this.BasesPerfilPuestoJS.prototype.abrirModalBuscarPerfilPuesto = function (e, tipo) {
        e.preventDefault();
        debugger;
        var modal = $('#ModalBuscarPerfilPuesto').data('kendoWindow');

        modal.title("Buscar Perfil de Puesto");            
        controlador.CargarPerfilesPuesto(e, tipo);
        modal.open(); //.center();
    }
    ...
    this.BasesPerfilPuestoJS.prototype.RegBasesPerfil = function (e, tipo) {
        e.preventDefault();
        var metodo = '';
        if ($("#hdIdCodBasePerfil").val() != "")
        ...
        if (frmRegBasesPerfil.validate()) {
            ...
            data_param.append('iTipoBase', tipo);
    ...
    this.BasesPerfilPuestoJS.prototype.CargarPerfilesPuesto = function (e, tipo) {
        debugger;
