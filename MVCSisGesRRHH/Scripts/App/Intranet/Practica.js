(function ($) {
    ...
    this.PracticaJS = function () { };
    this.PracticaJS.prototype.inicializar = function () {
        ...
        $('#divModalRegistroConvocatoria').kendoWindow({
            ...
            close: function () {
                ...
                $("#hdIdPerfil").val('0');
                $("#ddlOrgano").data("kendoDropDownList").value('');
                $("#ddlUUOO").data("kendoDropDownList").value('');
    ...
    this.PracticaJS.prototype.inicializarGrid = function () {
        this.$dataSource = [];
        this.$dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: controladorApp.obtenerRutaBase() + 'Practicas/ListarConvocatorias',
                    type: 'GET',
                    dataType: 'json',
                    cache: false
                },
    ...
    function detailInit(e) {
        ...
        detailRow.find(".postulantes").kendoGrid({
            ...
            dataSource: {
                ...
                transport: {
                    read: {
                        url: controladorApp.obtenerRutaBase() + 'Convocatoria/ListarPostulantesPractica',
                        type: 'GET',
                        dataType: 'json',
                        cache: false
                    },
    ...
    this.PracticaJS.prototype.buscar = function (e) {
        e.preventDefault();
    ...
    this.PracticaJS.prototype.abrirModalRegistroConvocatoria = function (id) {
    ...
    this.PracticaJS.prototype.abrirModalEdicionConvocatoria = function (id) {
        ...
        if (id != 0) {           
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $.ajax({
                        url: controladorApp.obtenerRutaBase() + 'Convocatoria/ListarConvocatoriaPracComite',
                        type: 'GET',
                        dataType: 'json',
                        data: data_param2,
                        success: function (resul) {
                            ...
                            if (res.IdTieneRequerimiento == 1) {
                                ...
                                $("#btnActualDocRequerimientoE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPractica/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=1');
                            ...
                            if (res.IdTieneCertificacion == 1) {
                                ...
                                $("#btnActualDocCertificacionE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPractica/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=2');
                            ...
                            if (res.IdTieneComite == 1) {
                                ...
                                $("#btnActualDocComiteE").attr("href", controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPractica/?idConvocatoria=' + res.IdConvocatoria + '&idTipo=3');
        ...
        this.$grid = $("#divGridCurricular").kendoGrid({
            ...
            sortable: false,
            pageable: false,
            detailTemplate: kendo.template($("#templateDoc").html()),
        ...
        this.$grid = $("#divGridEntrevistas").kendoGrid({
            ...
            columns: [
                ...
                //            controles += '<a href="' + controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPracticaEntrevista/?idEntrevista=' + item.IdEvaluacion + '" target="_blank" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-file" title="Descargar contrato firmado/aprobado"></span> DESCARGAR </a>';
                //        }
                //        else {
        ...
        this.$dataSourceTotales = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: controladorApp.obtenerRutaBase() + 'Convocatoria/ListarPostulantesPracticaResultadosTotales',
                    type: 'GET',
                    dataType: 'json',
                    cache: false
                },
                ...
                },
                {
                    ...
                    template: function (item) {
                        return (item.AptoGanador == 1 && item.Posicion <= item.Vacantes ? "<span style='background-color: RGB(199,249,215); padding: 2px; width: 95%; float: right; border-style: solid; border-width: 1px; border-color: RGB(145,206,191);'> <i class='fa fa-check'></i> GANADOR(A) </span>"
                            : (item.AptoGanador == 1 && item.Posicion - 1 == item.Vacantes ? "<span style='background-color: RGB(247,187,187); padding: 2px; width: 95%; float: right; border-style: solid; border-width: 1px; border-color: RGB(240,84,84);'> ACCESITARIO(A) </span>"
                                : '--'));
                    }
                }
            ]
        ...
        this.$gridComunicacion = $("#divGridComunicacion").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (item) {
                        var controles = "";
                        controles += '<a href="' + controladorApp.obtenerRutaBase() + 'Convocatoria/DescargarArchivoPracticaPorId/?idConvocatoriaDoc=' + item.IdConvocatoriaDocumento + '" target="_blank" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-file" title="Descargar comunicado"></span></a>';
    ...
    this.PracticaJS.prototype.abrirModalVisor = function (idPostulacion, idDetalle, idTipo) {
    ...
    this.PracticaJS.prototype.abrirModalFormato = function () {
    ...
    this.PracticaJS.prototype.abrirModalFormatoEnt = function (id, postulante, examen) {
    ...
    this.PracticaJS.prototype.cerrarModalRegistroConvocatoria = function () {
        var modal = $('#divModalRegistroConvocatoria').data('kendoWindow');
        modal.close();
    }
    this.PracticaJS.prototype.cerrarModalEdicionConvocatoria = function () {
        var modal = $('#divModalEdicionConvocatoria').data('kendoWindow');
        modal.close();
    }

    this.PracticaJS.prototype.TipoDocumentoDropDownEditor = function (container, options) {
    ...
    this.PracticaJS.prototype.EstadoDropDownEditor = function (container, options) {
        var data = [
    ...
    this.PracticaJS.prototype.CargarFormularioOrdenesServicio = function (id) {
    ...
    this.PracticaJS.prototype.NombreOrdenEditor = function (container, options) {
        $('<textarea required name="' + options.field + '" style="width: ' + (container.width() + 30) + 'px;height:' + (container.height() + 30) + 'px" />')
            .appendTo(container);
    };
    this.PracticaJS.prototype.FechaInicioEditor = function (container, options) {
    ...
    this.PracticaJS.prototype.FechaFinEditor = function (container, options) {
    ...
    this.PracticaJS.prototype.agregarConvocatoria = function (e) {
        e.preventDefault();
        ...
        if (frmRegistroConvocatoria.validate()) {
            ...
            if (kendo.parseDate($("#txtFechaInscripcionCV").data("kendoDatePicker").value()) > kendo.parseDate($("#txtFechaEvaluacionCV_Desde").data("kendoDatePicker").value())) {
                controladorApp.notificarMensajeDeAlerta('La fecha de evaluación de hoja de vida no puede ser menor que la fecha de registro del postulante');
                return false;
            }
            ...
            if (kendo.parseDate($("#txtFechaPubResultadoFinal").data("kendoDatePicker").value()) > kendo.parseDate($("#txtFechaSuscripcionContrato_Desde").data("kendoDatePicker").value())) {
                controladorApp.notificarMensajeDeAlerta('La fecha de suscripción de convenio no puede ser menor que la fecha de publicación de resultados finales');
                return false;
            }
            ...
            if (kendo.parseDate($("#txtFechaSuscripcionContrato_Desde").data("kendoDatePicker").value()) > kendo.parseDate($("#txtFechaSuscripcionContrato_Hasta").data("kendoDatePicker").value())) {
                controladorApp.notificarMensajeDeAlerta('La fecha de inicio de suscripción de convenio no puede ser mayor que la fecha de fin');
                return false;
            }
            ...
            data_param.append('IdBase', 0); //$("#ddlBases").data("kendoDropDownList").value());
            data_param.append('IdPerfil', 0); //$("#hdIdPerfil").val());
            data_param.append('IdOrgano', $("#ddlOrgano").data("kendoDropDownList").value());
            data_param.append('IdDependencia', $("#ddlUUOO").data("kendoDropDownList").value());
            data_param.append('NroAIRHSP', $("#txtAIRHSPConvocatoria").val());
            data_param.append('Meta', $("#txtMetaConvocatoria").val());
            //data_param.append('NroConvocatoria', $("#txtNroConvocatoria").val());
            data_param.append('NombreCargo', $("#txtCargoConvocatoria").val());
            data_param.append('CantidadVacantes', $("#txtCantidadConvocatoria").val());
            data_param.append('Remuneracion', $("#txtRemuneracionConvocatoria").val());
            data_param.append('Estado', 1);
            data_param.append('IdTipo', 2);
            ...
            if (file1.length == 0) {
                controladorApp.notificarMensajeDeAlerta('Debe seleccionar las bases de convocatoria de prácticas (Formato PDF)');
                return false;
            } else {
                if (file1.length == 0) {
            ...
            if (file2.length == 0) {
                controladorApp.notificarMensajeDeAlerta('Debe seleccionar el Anexo 01: Requerimiento de prácticas (Formato PDF)');
                return false;
            } else {
                if (file2.length == 0) {
            ...
            controladorApp.abrirMensajeDeConfirmacion(
                '<span>¿Está seguro de ingresar la convocatoria de prácticas?</span></br></br><div class="alert alert-warning" style="padding: 5px; border: 1px solid #f7cf0aa0;">Recuerde que al confirmar esta operación la convocatoria automaticamente será publicada</div>', 'SI', 'NO'
                , function (arg) {
                    $.ajax({
                        url: controladorApp.obtenerRutaBase() + 'Practicas/' + metodo,
                        type: 'POST',
                        dataType: 'json',
                        contentType: false,
                        processData: false,
    ...
    this.PracticaJS.prototype.actualizarConvocatoria = function (e) {
        e.preventDefault();
        var metodo = 'ActualizarPractica';
    ...
    this.PracticaJS.prototype.agregarEvaluacionEntrevista = function (e) {
        e.preventDefault();
        ...
        if (frmEvaluacionCurriValidador.validate()) {
            ...
            controladorApp.abrirMensajeDeConfirmacion(
                '<span>¿Está seguro de notificar el inicio de la entrevista personal a los miembros del comité seleccionados?</span></br></br><div class="alert alert-warning" style="padding: 5px; border: 1px solid #f7cf0aa0;">Recuerde que al confirmar esta operación los miembros del comité seleccionados podrán ingresar la evaluación de entrevistas personales del proceso de prácticas</div>', 'SI', 'NO'
                , function (arg) {
                    $.ajax({
                        url: controladorApp.obtenerRutaBase() + 'Convocatoria/RegistrarConvocatoriaPracComiteEntrevista',
                        type: 'POST',
                        dataType: 'json',
                        contentType: false,
                        processData: false,
    ...
    this.PracticaJS.prototype.agregarResultadoFinalArchivo = function (e) {
        e.preventDefault();
    ...
    this.PracticaJS.prototype.GenerarFormatoContrato = function () {
    ...
    this.PracticaJS.prototype.agregarConvocatoriaDocumento = function (e) {
        e.preventDefault();
    ...
    ////this.PracticaJS.prototype.actualizarTrabajadorContacto = function (e) {
    //    e.preventDefault();
    ...
    this.PracticaJS.prototype.cerrarModalFormato = function () {
        $('#divModalFormato').data('kendoWindow').close();
    }
    this.PracticaJS.prototype.cerrarModalFormatoEnt = function () {
        $('#divModalFormatoEnt').data('kendoWindow').close();
    }
    this.PracticaJS.prototype.cerrarModalVisor = function () {
        $('#divModalVisor').data('kendoWindow').close();
    }

    this.PracticaJS.prototype.inicializarGridConocimientos = function () {
        var data_param = new FormData();
        data_param.append('IdConvocatoria', $('#hdIdConvocatoria').val());
        //$.ajax({
    ...
    this.PracticaJS.prototype.inicializarGridCurricular = function () {
        var data_param = new FormData();
        data_param.append('IdConvocatoria', $('#hdIdConvocatoria').val());
    ...
    this.PracticaJS.prototype.ingresarDetalleEvaluacion = function (idCad, idEvaluacion) {
    ...
    this.PracticaJS.prototype.abrirModalEvaluacionCurri = function (IdConvocatoria) {
        //$("#fileFormato").data("kendoUpload").clearAllFiles();
        //$('#hdIdConvocatoria').val(IdConvocatoria);
        //var data_param = new FormData();
        //data_param.append('IdConvocatoria', IdConvocatoria);

        window.open(controladorApp.obtenerRutaBase() + 'Practicas/EvaluacionCurricular/?id=' + IdConvocatoria, '_blank');
    ...
    this.PracticaJS.prototype.abrirModalEvaluacionConocimiento = function (IdConvocatoria) {
        window.open(controladorApp.obtenerRutaBase() + 'Convocatoria/EvaluacionConocimiento/?id=' + IdConvocatoria, '_blank');
    }
    this.PracticaJS.prototype.abrirModalEvaluacionEntrevista = function (IdConvocatoria) {
        //$("#fileFormato").data("kendoUpload").clearAllFiles();
        $('#hdIdConvocatoria').val(IdConvocatoria);
    ...
    this.PracticaJS.prototype.ObservacionEditor = function (container, options) {
        $('<textarea name="' + options.field + '" style="width: 98%;" />')
            .appendTo(container);
    };
    this.PracticaJS.prototype.FechaEntrevistaEditor = function (container, options) {
    ...
    this.PracticaJS.prototype.HoraEntrevistaEditor = function (container, options) {
    ...
    this.PracticaJS.prototype.GenerarFormatoComunicado = function () {
        var IdConvocatoria = $('#hdIdConvocatoria').val();
        var IdTipo = $('#ddlTipoFormato').data("kendoDropDownList").value();

        window.open(controladorApp.obtenerRutaBase() + "Convocatoria/FichaComunicadoPractica?idConvocatoria=" + IdConvocatoria + "&idTipo=" + IdTipo, "_blank");
    }
    this.PracticaJS.prototype.GenerarFormatoResultadoFinal = function () {
        var IdConvocatoria = $('#hdIdConvocatoria').val();

        window.open(controladorApp.obtenerRutaBase() + "Convocatoria/DescargarAnexo11Practica?id=" + IdConvocatoria, '_blank');
    }
    this.PracticaJS.prototype.cerrarModalEliminacion = function () {
        var modal = $('#divModalEliminacion').data('kendoWindow');
        $('#hdnUid').val('');
        modal.close();
    }

    this.PracticaJS.prototype.eliminar = function () {
        var modal = $('#divModalEliminacion').data('kendoWindow');
        var grilla = $('#divGrid').data("kendoGrid");
    ...
    this.PracticaJS.prototype.EliminarComunicado = function (IdComunicado) {
        var data_param = new FormData();
        ...
        controladorApp.abrirMensajeDeConfirmacion(
            ...
            , function (arg) {
                $.ajax({
                    url: controladorApp.obtenerRutaBase() + 'Convocatoria/EliminarComunicadoPractica',
                    type: 'POST',
                    dataType: 'json',
                    contentType: false,
                    processData: false,
