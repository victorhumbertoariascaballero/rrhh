(function ($) {
    ...
    this.SobretiempoJS.prototype.inicializarMaestro = function () {
    ...
    this.SobretiempoJS.prototype.inicializarGridMaestro = function () {
        var _this = this;
        this.$dataSource = [];
    ...
    this.SobretiempoJS.prototype.buscar = function (e) {
        e.preventDefault();
        ////debugger;
    ...
    this.SobretiempoJS.prototype.generarColumnas = function (nroDias) {
        var columnas = [
            {
