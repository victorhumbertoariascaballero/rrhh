(function ($) {
    ...
    this.ConceptoFijoVariableJS.prototype.inicializarBandejaConceptoVariable = function () {
        ...
        $("#ddlSubTipoConcepto").kendoDropDownList({
            ...
            dataSource: {
                ...
                transport: {
                    read: {
                        url: controladorApp.obtenerRutaBase() + "Concepto/ListarSubTipoConceptoNoBaseImponible",
                        type: "GET",
                        dataType: "json",
                        cache: false
                    },
        ...
        $("#ddlConcepto").kendoDropDownList({
            ...
            dataSource: {
                ...
                transport: {
                    read: {
                        url: controladorApp.obtenerRutaBase() + "Concepto/ListarConceptoPorTipoNoBaseImponible",
                        type: "GET",
                        dataType: "json",
                        cache: false
                    },
    ...
    this.ConceptoFijoVariableJS.prototype.CargarGrillaConceptoTrabajador = function (e) {
        ...
        this.$dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: controladorApp.obtenerRutaBase() + 'ConceptoFijoVariable/ListarConceptoVariableNoBaseImponible',
                    type: 'POST',
                    dataType: 'json',
                    cache: false
                },
